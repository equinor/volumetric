...
Revision ID: 840a8035756b
Revises: 
Create Date: 2018-05-09 07:43:14.375910
...
def schema_upgrades():
    ...
    op.create_table('field', sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('location', sa.Column('id', sa.Integer(), nullable=False),
                    ...
                    sa.ForeignKeyConstraint(
                        ...
                        onupdate='CASCADE',
                        ondelete='CASCADE'), sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('faultblock_id', 'zone_id', 'facies'))
    op.create_table(
