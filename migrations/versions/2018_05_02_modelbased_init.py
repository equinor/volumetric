...
Revision ID: 478527d89272
Revises: 
Create Date: 2018-05-02 12:20:01.586372
...
def schema_upgrades():
    ...
    sa.ForeignKeyConstraint(['faultblock_id'], ['faultblock.id'], ),
    sa.ForeignKeyConstraint(['model_id'], ['model.id'], ),
